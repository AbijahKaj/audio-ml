...
export type DemoPage = 'analyzers' | 'vad' | 'denoiser' | 'beep-detector' | 'speech-recognizer';
...
export class Router {
  ...
  private getPageFromHash(): DemoPage | null {
    ...
    if (hash === 'vad' || hash === 'denoiser' || hash === 'beep-detector' || hash === 'analyzers' || hash === 'speech-recognizer') {
